...
public class Verification_screenActivity extends AppCompatActivity {
    EditText otp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkCode= findViewById(R.id.verify);
    ...
    private void checkCode() {
        ...
        if (inputString.equals(code)) {
            if(fromForget){
                startActivity(new Intent(this, com.example.project.SetPasswordActivity.class));
            }else {
